const ARRAY_COURSES_GROUPS = [
  {
    "BTc-241-BTc-242-TMc-241": ["BTc-241", "BTc-242", "TMc-241"],
    "МДс-241-ЭКс-241-ПОс-241": ["МДс-241", "ЭКс-241", "ПОс-241"],
  },
  {
    "BTc-231-BTc-232-TMc-231": ["BTc-231", "BTc-232", "TMc-231"],
    "МДс-231-ЭКс-231-ПОс-231": ["МДс-231", "ЭКс-231", "ПОс-231"],
  },
  {
    "BTc-221-BTc-222-BTc-223": ["BTc-221", "BTc-222", "BTc-223"],
    "МДс-221-ЭКс-221-ПОс-221": ["МДс-221", "ЭКс-221", "ПОс-221"],
  },
  {
    "BTc-211-BTc-212": ["BTc-211", "BTc-212"],
  },
];
...
function saveCurrentTableData(key) {
  ...
  downloadTableAsPdf(table, key, "http://localhost:3000/upload-pdf-mailing");
}
